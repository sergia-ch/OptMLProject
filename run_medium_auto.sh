...
sleep 5
pids=""
python experiment.py --optimizer frankwolfe --train_batch_size 1000 --R 20.0 --gamma -1 --ro -1 --epochs 100 --image_side 5 --giveup 100 --accuracy_threshold 0.0 --p 3.0 --repetitions 3 --architecture 20_10 &
python experiment.py --optimizer frankwolfe --train_batch_size 1000 --R 20.0 --gamma -1 --ro 0.0 --epochs 100 --image_side 5 --giveup 100 --accuracy_threshold 0.0 --p 3.0 --repetitions 3 --architecture 20_10 &
python experiment.py --optimizer frankwolfe --train_batch_size 1000 --R 20.0 --gamma -1 --ro 0.5 --epochs 100 --image_side 5 --giveup 100 --accuracy_threshold 0.0 --p 3.0 --repetitions 3 --architecture 20_10 &
python experiment.py --optimizer frankwolfe --train_batch_size 1000 --R 20.0 --gamma -1 --ro 1.0 --epochs 100 --image_side 5 --giveup 100 --accuracy_threshold 0.0 --p 3.0 --repetitions 3 --architecture 20_10 &
wait $pids
sleep 5
pids=""
python experiment.py --optimizer frankwolfe --train_batch_size 1000 --R 20.0 --gamma 0.0 --ro -1 --epochs 100 --image_side 5 --giveup 100 --accuracy_threshold 0.0 --p 3.0 --repetitions 3 --architecture 20_10 &
python experiment.py --optimizer frankwolfe --train_batch_size 1000 --R 20.0 --gamma 0.0 --ro 0.0 --epochs 100 --image_side 5 --giveup 100 --accuracy_threshold 0.0 --p 3.0 --repetitions 3 --architecture 20_10 &
python experiment.py --optimizer frankwolfe --train_batch_size 1000 --R 20.0 --gamma 0.0 --ro 0.5 --epochs 100 --image_side 5 --giveup 100 --accuracy_threshold 0.0 --p 3.0 --repetitions 3 --architecture 20_10 &
python experiment.py --optimizer frankwolfe --train_batch_size 1000 --R 20.0 --gamma 0.0 --ro 1.0 --epochs 100 --image_side 5 --giveup 100 --accuracy_threshold 0.0 --p 3.0 --repetitions 3 --architecture 20_10 &
wait $pids
sleep 5
pids=""
python experiment.py --optimizer frankwolfe --train_batch_size 1000 --R 20.0 --gamma 0.5 --ro -1 --epochs 100 --image_side 5 --giveup 100 --accuracy_threshold 0.0 --p 3.0 --repetitions 3 --architecture 20_10 &
...
sleep 5
pids=""
python experiment.py --optimizer frankwolfe --train_batch_size 1000 --R 20.0 --gamma 1.0 --ro -1 --epochs 100 --image_side 5 --giveup 100 --accuracy_threshold 0.0 --p 3.0 --repetitions 3 --architecture 20_10 &
