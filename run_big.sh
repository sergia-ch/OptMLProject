...
sleep 5
pids=""
python experiment.py --optimizer frankwolfe --train_batch_size 60000 --R 20.0 --gamma -1.0 --ro 1.0 --epochs 1000 --image_side 10 --giveup 100 --accuracy_threshold 0.0 --p 3.0 --repetitions 15 --architecture 50_50_20 &
python experiment.py --optimizer frankwolfe --train_batch_size 60000 --R 20.0 --gamma 0.1 --ro 1.0 --epochs 1000 --image_side 10 --giveup 100 --accuracy_threshold 0.0 --p 3.0 --repetitions 15 --architecture 50_50_20 &
sleep 5
python experiment.py --optimizer frankwolfe --train_batch_size 60000 --R 20.0 --gamma 0.5 --ro 1.0 --epochs 1000 --image_side 10 --giveup 100 --accuracy_threshold 0.0 --p 3.0 --repetitions 15 --architecture 50_50_20 &
