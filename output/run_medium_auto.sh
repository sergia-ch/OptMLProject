...
sleep 5
pids=""
python experiment.py --optimizer frankwolfe --train_batch_size 60000 --R 20.0 --gamma -1 --ro 1.0 --epochs 500 --image_side 5 --giveup 100 --accuracy_threshold 0.0 --p 3.0 --repetitions 3 --architecture 20_10 &
